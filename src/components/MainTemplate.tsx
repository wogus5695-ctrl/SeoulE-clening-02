                ...
                : [
                    {
                      ...
                      a: '공간의 면적, 오염 종류, 그리고 자재(석재, 외벽유리, 패브릭 등) 조건에 따라 책정됩니다. 대표번호 전화로 문의주시면 신속하고 상세하게 상담 및 가견적 안내를 도와드리며, 상가 건물이나 빌딩 외벽처럼 규모가 큰 경우 무상 현장 방문 견적도 가능합니다.'
                    },
                    {
                      q: '사진으로도 가견적 확인이 가능한가요?',
                      a: '네, 가능합니다. 전화 상담 진행 중 안내에 따라 청소가 필요한 부분의 사진을 찍어서 보내주시면 대략적인 금액과 작업 소요 시간을 신속히 안내해 드립니다.'
                    },
                    {
                      q: '영업 중인 매장도 작업할 수 있나요?',
                      a: '주방 후드 오염 세척이나 바닥 왁스코팅 등은 안전 및 보행 통제 문제로 영업 중 시공은 가급적 피하고 있습니다. 대신 매장의 영업이 완전히 종료된 심야 시간대나 브레이크 타임 시간대를 조율하여 시공을 신속히 마무리해 드립니다.'
                    },
                    {
                      q: '작업 일정은 어떻게 조율하나요?',
                      a: '올케어 서비스는 직장인 업무 방해나 매장 영업 지장을 방지하기 위해 고객님의 요청에 따라 야간 심야 시공 및 토요일/일요일/공휴일 일정에 맞춰 직영 팀을 항시 유동적으로 배치 운영합니다.'
                    }
                  ];
